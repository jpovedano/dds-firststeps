...
if __name__ == '__main__':
    ...
    cliparser.add_argument("--secondary", help="sensor identifier", action='store_true')
    ...
    if args.secondary: 
        writer = connector.getOutput("TempPublisher::TempWriterSecondary")
    else:
        writer = connector.getOutput("TempPublisher::TempWriterPrimary")
