...
if __name__ == '__main__':
    ...
    cliparser.add_argument("--zone", help="sensor zone", default='A')
    ...
    if args.zone == 'A':
        writer = connector.getOutput("TempPublisherZoneA::TempWriter")
    else:
        writer = connector.getOutput("TempPublisherZoneB::TempWriter")
